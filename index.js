...
function loadPage(changingData, d) {
  ...
  // xhttp.onload = function() {
    ...
    console.log()
    // document.getElementsByClassName('message')[0].innerHTML = JSON.stringify(currentTopicObject.definition);
    d3.selectAll('text').transition(1000)
      .attr('opacity', 0)
    d3.selectAll('g').transition(2000)
      .remove()
    render(svg1, data)
    // render(svg2, data)
  }
